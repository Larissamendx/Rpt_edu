import ifrsLogo from "../../assets/ifrs-red.png";
    ...
    <main>
      ...
      <div className="relative flex flex-col px-4 pt-4 pb-5 gap-4 sm:px-6 sm:pt-6 sm:pb-8 md:px-10 md:pt-10 md:pb-12
       lg:gap-0 lg:pl-[180px] lg:pt-[100px] xl:pr-[140px] lg:pb-[50px] lg:items-end text-primary-100 z-30">
        ...
        <CourseCard 
          variant="secondary" 
          title="Curso oficial de Relato Integrado da IFRS" 
          subtitle="Internacional Financial Reporting Standards"
        ...
        <img src={ifrsLogo} alt="GRI Logo" className="order-first w-max self-end lg:self-auto lg:order-none lg:mr-10 lg:mb-[82px]"/>
        ...
        <div className="lg:absolute flex items-start md:gap-[40px] text-salmon-200 lg:right-4
         text-[1.33em] leading-[1.25em] top-[26px] xl:right-24 2xl:right-[280px]">
          ...
          <div className="flex flex-1 md:flex-none items-start gap-2 sm:gap-[10px]">
            <img src={calendar} />
            <div>
              <strong className="font-main-semibold-italic">módulo introdutório</strong>
              <p className="font-main-light-italic">12 de janeiro</p>
            </div>
          </div>
        </div>
