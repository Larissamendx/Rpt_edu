      ...
      pt-[58px] pb-[44px] md:flex-row text-primary-100 relative bg-base-200">
        <div>
          <div className="mb-[52px]">
            <span>International Financial Reporting Standards</span>
            <h2 className="block font-main-semibold text-[2.37em] mb-[38px]">módulo introdutório</h2>
          </div>
            ...
            date={
              <p>
                ...
                <span className="font-main-light-italic">
                  dias<span className="text-[1.78em] leading-[1.25em]"> 12/01, 19/01, 26/01 e 02/02 | de 8h às 11h</span>
                </span><br/>
                <span>de 8h às 11h</span>
              </p>
            }
            price="R$ 3 mil"
