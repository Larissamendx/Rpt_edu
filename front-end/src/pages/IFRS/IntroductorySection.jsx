    ...
    pt-[58px] pb-[44px] md:flex-row text-primary-100 relative">
      <div>
        <div className="mb-[52px]">
          <span>Relato Integrado - IFRS Foundation</span>
          <h2 className="block font-main-semibold text-[2.37em] mb-[38px]">nível introdutório</h2>
        </div>
          ...
          date={
            <p>
              ...
              <span className="font-main-light-italic">
                dias<span className="text-[1.78em] leading-[1.25em]"> 13, 20, 27/9 e 04/10</span>
              </span><br/>
